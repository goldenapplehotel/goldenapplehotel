...
//defined('SITE_DIR') OR define ('SITE_DIR', '/');
//
//define('DB_NAME','triptwoc_ci_sample');
//define('DB_USERNAME','triptwoc_cambodi');
//define('DB_PASSWORD','ZOwZaW8x5MVf');
//----------------------------All link define here-------------------------
//cms controller
define('HOME','cms/index');
define('HOTEL_URL','cms/hotel');
define('HOTEL_DETAIL','cms/hotel_detail');
define('LOGO_URL','assets/img/logo/logo.png');
//end 

//user controller
define('LOGIN_URL','users/login');
define('SIGN_UP_URL','users/sign_up');
define('LOGOUT_URL','users/logout');
//end

//mypage controller
define('NEW_BUSINESS_URL','mypage/new_business');
